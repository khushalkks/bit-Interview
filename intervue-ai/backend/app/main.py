...
from app.api import auth, dashboard, resume, interview, websocket_interview, recruiter, coding

app = FastAPI(
    title=settings.PROJECT_NAME,
    version=settings.VERSION,
    description="Bit-Interview Backend API - Adaptive AI Interview Platform"
)
...
def health_check():
    return {
        "status": "ok",
        "message": "Bit-Interview backend is running"
    }
