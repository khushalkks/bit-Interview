...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#090d16] bg-grid-pattern text-slate-100 flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[350px] bg-cyan-600/15 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <motion.div
          ...
          className="p-6 sm:p-8 rounded-2xl bg-slate-900/80 border border-slate-800 shadow-2xl backdrop-blur-xl space-y-5"
        >
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full bg-[#080c16] border border-slate-800 focus:border-indigo-500/80 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white outline-none transition-colors appearance-none"
                >
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-gradient-to-r from-indigo-500 via-blue-600 to-cyan-500 hover:from-indigo-600 hover:to-cyan-600 text-white font-semibold text-sm shadow-lg shadow-indigo-500/25 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 mt-2"
            >
              {isSubmitting ? (
