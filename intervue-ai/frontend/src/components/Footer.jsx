...
export default function Footer() {
  return (
    <footer className="bg-[#05080e] border-t border-slate-800/80 text-slate-400 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-slate-800/60">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="flex items-center gap-4 text-slate-400 pt-2">
              {/* GitHub SVG */}
              <a href="https://github.com" target="_blank" rel="noreferrer" className="hover:text-white transition-colors p-1" aria-label="GitHub">
              ...
              {/* Twitter SVG */}
              <a href="https://twitter.com" target="_blank" rel="noreferrer" className="hover:text-white transition-colors p-1" aria-label="Twitter">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              {/* LinkedIn SVG */}
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="hover:text-white transition-colors p-1" aria-label="LinkedIn">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
          ...
          <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#analytics" className="hover:text-indigo-400 transition-colors">Pricing</a></li>
                <li><a href="#analytics" className="hover:text-indigo-400 transition-colors">Analytics Preview</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#interview-types" className="hover:text-indigo-400 transition-colors">Technical Interview</a></li>
                <li><a href="#interview-types" className="hover:text-indigo-400 transition-colors">Coding Practice</a></li>
                <li><a href="#interview-types" className="hover:text-indigo-400 transition-colors">Behavioral STAR</a></li>
                <li><a href="#interview-types" className="hover:text-indigo-400 transition-colors">System Design</a></li>
              </ul>
            </div>
